...
███   ███   ███    ███  ▄███     ███▄  ███    ███    ▄█    ███ 
 ▀█   █▀    ██████████ ████       ███▄ ████████▀   ▄████████▀  
   ...
   Welcome to the Nexus Dox Tool! Press "Enter" to continue.
                  Telegram: t.me/pr0xit
"""
...
if os.name == "nt":
    os.system("cls")
    os.system("title Nexus Dox Tool")
if os.name == "posix":
    os.system("clear")
...
def about():
    ...
    """
    print(Fore.GREEN)
    printer.nonprefix(f"Nexus, toolkit for scraping, OSINT and more.\n")
...
def handle_exit():
    ...
    printer.info("Thanks for using Nexus!")
    time.sleep(1)
    print(Fore.RESET)
    exit()
